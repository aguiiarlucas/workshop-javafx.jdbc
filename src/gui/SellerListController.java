...
public class SellerListController implements Initializable, DataChangeListener {
	...
	// __________Referencias para o SellerList_________
	...
	@FXML
	public void onButtonAction(ActionEvent event) { // tratamento de evento para clicar no bot�o
	...
	// _________Macete padr�o para iniciar o comportamento das columnas_________
	...
	// _________M�todo respons�vel por acessar , carregar e jogar os dep no ObsList;
	public void updateTableView() {

		if (service == null) { // if de seguran�a ; esqueceu .
	...
	private void removeEntity(Seller obj) {
		...
		if (result.get() == ButtonType.OK) {
			...
			try {
				...
				Alerts.showAlerts("Error removing object", null, e.getMessage(), AlertType.CONFIRMATION);
			}
		}
